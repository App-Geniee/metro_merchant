...
class ProcessingAmountCard extends StatelessWidget {
  const ProcessingAmountCard({Key? key}) : super(key: key);
          ...
          children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("4500", style: semiBoldDefault.copyWith(color: AppColors.colorBlack)),
                  ],
                )
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => Get.toNamed(AppRoute.paymentDetailsScreen, arguments: ["Processing", AppColors.colorBlue]),
                  child: Text(
                    "View invoice",

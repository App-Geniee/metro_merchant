...
import 'package:metro_merchant/views/screens/oder_history/order_histroy.dart';
                              ...
                              title: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    ,style: TextStyle(fontSize: 14,color: AppColors.colorBlack,fontWeight: FontWeight.w700),),
                                  ),
                                  SizedBox(height: 10,),
                                  Divider(color: AppColors.colorBlack300,)
                                ],
                                ...
                                TextButton(
                                  ...
                                  child: Center(
                                    child: Container(
                                      ...
                                      child: Center(child: Text("CLOSE",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600,color: Colors.white),),),
                                    ),
                                  ),
                                )
                              ],
